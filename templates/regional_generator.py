...
class RegionalGenerator:
    ...
    QUARTER_COLS = {
        ...
        "F'분석": {
            '2023_1Q': 10, '2023_2Q': 11, '2023_3Q': 12, '2023_4Q': 13,
        ...
        'D(고용률)분석': {
            '2023_1Q': 9, '2023_2Q': 10, '2023_3Q': 11, '2023_4Q': 12,
    ...
    def extract_chart_data(self, region: str) -> Dict[str, Any]:
        ...
        def get_mig_series(df, region_name, age_filter=None, convert_to_thousands=True):
            ...
            if age_filter:
                ...
                result = []
                for q, k in zip(quarters, keys):
                    col = self.QUARTER_COLS['I(순인구이동)집계'].get(k)
                    if col is None:
                        result.append({"period": q, "value": 0})
                        continue
