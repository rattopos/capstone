#!/usr/bin/env python3
"""
지역경제동향 보도자료 자동 생성 시스템 - 발표 PPT 생성기
...
def create_presentation():
    ...
    # 슬라이드 10: 섹션 3 - 주요 기능
    # ========================================
    add_title_slide(prs, "3. 주요 기능", "50개 보도자료 자동 생성")
    
    # ========================================
    # 슬라이드 11: 생성 가능한 보도자료
    # ========================================
    add_highlight_box_slide(prs, "📄 생성 가능한 보도자료 (총 50개)", [
        ("📋 요약 보도자료 (9개)", "표지, 일러두기, 목차\n인포그래픽\n지역경제동향 요약 5개"),
        ("📊 부문별 보도자료 (10개)", "광공업생산, 서비스업생산\n소비동향, 건설동향\n수출, 수입, 물가\n고용률, 실업률, 인구이동"),
        ("🗺️ 시도별 보도자료 (18개)", "17개 시도별 보도자료\n+ 참고 GRDP"),
        ("📈 통계표 (13개)", "각 부문별 통계표\n+ GRDP + 부록"),
    ], notes="50개 보도자료를 카테고리별로 설명합니다.")
    ...
    add_content_slide(prs, "📐 스키마 기반 데이터 추출", [
        ...
        "",
        "- 업종명 매핑 자동화",
        "  - 긴 공식 명칭 → 보도자료용 축약형 변환",
        "  - 예: '전자 부품, 컴퓨터...' → '반도체·전자부품'",
        "",
        "- 확장성 확보",
        "  - 새로운 보도자료: 스키마만 작성하면 됨",
    ...
    ], notes="순위 시스템이 보도자료 설명 문구 자동 생성에 어떻게 활용되는지 설명하세요.")
    ...
    # ========================================
    add_content_slide(prs, "😰 어려움 3: 보도자료 서식 변경", [
        "📌 상황:",
        "- 프로젝트 진행 중 2024년 4분기부터 보도자료 서식 변경",
        "- 기존 개발한 템플릿 구조 재설계 필요",
        "",
        "💪 극복:",
        "- 템플릿 기반 모듈화 설계로 수정 범위 최소화",
        "- 데이터와 표현 계층 분리로 유지보수성 확보",
        "- 변경된 실제 보도자료를 분석하여 신규 서식 파악",
        "",
        "✅ 결과:",
        "- 서식 변경에 성공적으로 대응",
        "- 확장 가능한 템플릿 구조 구축",
